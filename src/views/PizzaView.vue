        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <!--div class="input-group mb-3">
              ...
              <input type="text" class="form-control" v-model="PizzaLinkkep" />
            </div-->
...
export default {
  ...
  methods: {
    ...
    adatbazisbaTeszClick(termek, termekkategoria, darab) {
      ...
      //megnézni, hogy van-e már megrendelés indítva
      //ameenyiben nincs akkor a rendeles adatbázisba beleteszem a megrendelo id-jét üres statusszal
      //illetve a rendelesadatok táblába felveszem a visszakapott rendelés id, és a fenti darab és termek adatokat
      //a visszakapot rendeles id-t betöltöm a store-ban lévö rendelesId nevű változóba
      //amennyiben már van rendelése indítva akkor csal a rendelesadatok táblába rögzítem a kapott adatokat
    },
    addClick() {
